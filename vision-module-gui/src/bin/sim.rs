    ...
    fn new() -> Self {
        ...
        Self {
            ...
            markers: vec![
                ...
                tf * Point3::new(0.5, 0.98, 0.0),
                tf * Point3::new(0.8, 0.98, 0.0),
                tf * Point3::new(0.2, 0.0355555555555555555555555555555555555555555, 0.0),
                tf * Point3::new(0.5, 0.0355555555555555555555555555555555555555555, 0.0),
                tf * Point3::new(0.8, 0.0355555555555555555555555555555555555555555, 0.0),
                tf * Point3::new(1.2, 0.98, 0.0),
                tf * Point3::new(1.5, 0.98, 0.0),
                tf * Point3::new(1.8, 0.98, 0.0),
                tf * Point3::new(1.2, 0.0355555555555555555555555555555555555555555, 0.0),
                tf * Point3::new(1.5, 0.0355555555555555555555555555555555555555555, 0.0),
                tf * Point3::new(1.8, 0.0355555555555555555555555555555555555555555, 0.0),
